  ...
  <div>
    ...
    <div class="gap-4 p-4 border border-gray-700 rounded-md text-gray-300">
      ...
      >
        ...
        <div>
          <span class="mr-1 text-gray-400"
            >{{ $t("profile.completion.top20") }}:</span
          >
        ...
        <div>
          <span class="mr-1 text-gray-400"
            >{{ $t("profile.completion.top50") }}:</span
          >
        ...
        <div>
          <span class="mr-1 text-gray-400"
            >{{ $t("profile.completion.points") }}:</span
          >
